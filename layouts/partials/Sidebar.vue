            ...
            <ul id="sidebar_menu">
                <li class>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/index_3.html">Light Sidebar</a>
                        </li>
                        <li>
                            <a href="/index-2.html">Dark Sidebar</a>
                        </li>
                    </ul>
                </li>
                <li class>
                ...
                <li class>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/important_mail.html">Important Mail</a>
                        </li>
                        <li>
                            <a href="/mail_trash.html">Mail Trash</a>
                        </li>
                        <li>
                ...
                <li class>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/color_plate.html">Color Plate</a>
                        </li>
                        <li>
